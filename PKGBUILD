...
depends=('boost-libs' 'icu' 'libpng' 'libjpeg' 'libtiff' 'freetype2'
	 'libxml2' 'python>=2.4' 'proj' 'cairo' 'cairomm' 'pycairo'
...
makedepends=('python>=2.4' 'libtool' 'scons' 'boost') # already in core ('pkg-config')
...
build() {
  ...
  chmod 644 "${pkgdir}/usr/lib/python2.6/site-packages/mapnik/paths.py"
}
